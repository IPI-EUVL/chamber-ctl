...
_EXPOSURE_START_UNSPECIFIED = EXPOSURE_START_UNSPECIFIED
...
def analyze_snapshot(start, end, data, indexes, is_step_exposure: bool | None = None, *, exposure_start_ns=_EXPOSURE_START_UNSPECIFIED) -> SnapshotAnalysis:
    ...
    return SnapshotAnalysis(
        ...
        pulse_times_seconds=analysis.pulse_times_seconds,
        pulse_indexes=analysis.pulse_indexes,
        pulse_doses_mj_cm2=analysis.pulse_doses_mj_cm2,
        pulse_peaks_volts=analysis.pulse_peaks_volts,
        ...
        inferred_step_exposure=analysis.inferred_step_exposure,
